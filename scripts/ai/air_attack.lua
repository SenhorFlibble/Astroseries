...
local end_loop_air_funcs = {
  ...
  function() return AiForce(5, {AiFighters(), 2, AiFlyer(), 2, AiBattleship(), 2, AiScout(), 1}) end,
  function() return AiForce(6, {AiFighters(), 1, AiFlyer(), 1, AiBattleship(), 1, AiScout(), 1}) end,
