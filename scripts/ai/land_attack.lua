...
local end_loop_funcs = {
  ...
  function() return AiForce(0, {AiSoldier(), 1, AiEliteShooter(), 2, AiCavalry(), 4, AiCatapult(), 1, AiMage(), 4}) end,

  function() return AiForce(1, {AiSoldier(), 1, AiEliteShooter(), 2, AiCavalry(), 4, AiCatapult(), 1, AiMage(), 2}) end,
...
local land_funcs = {
  ...
  function() return AiForce(0, {AiSoldier(), 1, AiShooter(), 2, AiCavalry(), 0, AiCavalry(), 5, AiCatapult(), 1}) end,
  function() return AiForce(1, {AiSoldier(), 1, AiShooter(), 2, AiCavalry(), 0, AiCavalry(), 3, AiCatapult(), 1}) end,
  function() return AiWaitForce(1) end,
  function() return AiAttackWithForce(1) end,
  ...
  function() return AiForce(0, {AiSoldier(), 1, AiShooter(), 2, AiCavalry(), 6, AiCatapult(), 3, AiMage(), 2}) end,
  function() return AiForce(0, {AiSoldier(), 1, AiShooter(), 2, AiCavalry(), 2, AiCatapult(), 1, AiMage(), 1}) end,
  function() return AiWaitForce(1) end,
  function() return AiAttackWithForce(1) end,
  ...
  function() return AiForce(0, {AiSoldier(), 1, AiShooter(), 2, AiCavalry(), 6, AiCatapult(), 1, AiMage(), 5}) end,
  function() return AiForce(1, {AiSoldier(), 1, AiShooter(), 2, AiCavalry(), 2, AiCatapult(), 1, AiMage(), 1}) end,
  function() return AiWaitForce(1) end,
  function() return AiAttackWithForce(1) end,
  ...
  function() return AiForce(0, {AiSoldier(), 1, AiShooter(), 0, AiEliteShooter(), 2, AiCavalry(), 6, AiCatapult(), 1, AiMage(), 5}) end,
  function() return AiForce(1, {AiSoldier(), 1, AiShooter(), 0, AiEliteShooter(), 2, AiCavalry(), 2, AiCatapult(), 1, AiMage(), 1}) end,
  function() return AiForce(2, {AiFlyer(), 1}) end,
  function() return AiWaitForce(2) end,
  function() return AiAttackWithForce(1) end,
  function() return AiAttackWithForce(2) end,
