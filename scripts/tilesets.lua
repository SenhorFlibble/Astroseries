...
DefineTileset("tileset-winter", "class", "winter", "name", "Ice",
  "file", "scripts/tilesets/winter.lua")
DefineTileset("tileset-wasteland", "class", "wasteland", "name", "Desert",
  "file", "scripts/tilesets/wasteland.lua")
DefineTileset("tileset-swamp", "class", "swamp", "name", "Space",
