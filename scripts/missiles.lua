...
DefineMissileType("missile-fireball",
  ...
  ImpactSound = "default-impact",
  DrawLevel = 50, Class = "missile-class-point-to-point-bounce", NumBounces = 5, Sleep = 1, Speed = 16, Range = 2,  SplashFactor = 6, ImpactMissile = "missile-explosion" } )
...
DefineMissileType("missile-blizzard",
  ...
  DrawLevel = 100, SplashFactor = 3} )



-- Death and decay is a nuke, used by the huge capital starships

DefineMissileType("missile-death-and-decay",
  { File = "missiles/nuke.png", Size = {96, 96}, Frames = 4, NumDirections = 1,
  DrawLevel = 100, Class = "missile-class-whirlwind", Sleep = 1, Speed = 0, Range = 6, SplashFactor = 2, CanHitOwner = true} )
...
DefineMissileType("missile-big-cannon",
  ...
  DrawLevel = 50, ImpactSound = "default-impact",
...
DefineMissileType("missile-turtle-missile",
  { File = "missiles/nshell.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
...
DefineMissileType("missile-daemon-fire",
  ...
  DrawLevel = 70, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 16, Range = 1 } )
...
DefineMissileType("missile-death-coil",
  { File = "missiles/touch_of_death.png", Size = {32, 32}, Frames = 30, NumDirections = 5,
  DrawLevel = 50, Class = "missile-class-point-to-point", Sleep = 1, Speed = 16, Range = 0 } )
...
DefineMissileType("missile-critter-explosion",
  { File = "missiles/catapult_rock.png", Size = {32, 32}, Frames = 15, NumDirections = 5,
  ImpactSound = "default-impact", DrawLevel = 50,
...
--- Astroseries more specific missiles


DefineMissileType("missile-laser",
  { File = "missiles/laser.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )

DefineMissileType("missile-dlaser",
  { File = "missiles/dlaser.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )

DefineMissileType("missile-tlaser",
  { File = "missiles/tlaser.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )


DefineMissileType("missile-shell",
  { File = "missiles/shell.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 24, Range = 0} )


DefineMissileType("missile-dual-shell",
  { File = "missiles/dshell.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 24, Range = 0 } )


DefineMissileType("missile-rocket",
  { File = "missiles/rocket.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )



DefineMissileType("missile-blaster",
  { File = "missiles/blaster.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )

DefineMissileType("missile-dblaster",
  { File = "missiles/dblaster.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )

DefineMissileType("missile-tblaster",
  { File = "missiles/tblaster.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )
...
DefineMissileType("missile-normal-plasma",
  { File = "missiles/plasma.png", Size = {32, 32}, Frames = 15, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 24, Range = 0} )


-- Fast plasma has better accuracy, good for the nagoran mtila, etc 

DefineMissileType("missile-fast-plasma",
  { File = "missiles/plasma.png", Size = {32, 32}, Frames = 15, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 24, Range = 0} )
...
DefineMissileType("missile-xzone",
  { File = "missiles/xzone.png", Size = {64, 64}, Frames = 8, NumDirections = 5,
  DrawLevel = 50, Class = "missile-class-point-to-point", Sleep = 1, Speed = 16, Range = 0 } )
...
DefineMissileType("missile-std-blaster",
  { File = "missiles/sblaster.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )



DefineMissileType("missile-tri-blaster",
  { File = "missiles/tri_blaster.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )


DefineMissileType("missile-energy",
  { File = "missiles/energy.png", Size = {40, 40}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )



DefineMissileType("missile-big-energy",
  { File = "missiles/big_energy.png", Size = {80, 80}, Frames = 5, NumDirections = 5,
  DrawLevel = 50, ImpactSound = "default-impact",
  Class = "missile-class-point-to-point", Sleep = 1, Speed = 32, Range = 0 } )
