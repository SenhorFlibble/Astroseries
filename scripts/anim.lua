...
DefineAnimations("animations-ballista",
  ...
  "move", {	-- #32, P32
    ...
    { 3, 2,   1,   0}},
  "attack", {	-- #200
    { 0, 0,  10,  10}, {12, 0,  12,  15}, { 0, 0, 14,  15}, { 0, 0,  16,   0},
    { 3, 0,   1,   0}})
...
DefineAnimations("animations-manta",
  "still", {	-- #5
    { 0, 0,   4,   0}, { 3, 0,   1,   0}},
  "move", {	-- #12, P32
    { 0, 3,   1,   0}, { 0, 3,   1,   5}, { 0, 3,   1,   5}, { 0, 3,   1,  10},
    { 0, 3,   1,  10}, { 0, 3,   1,  15}, { 0, 3,   1,  15}, { 0, 3,   1,  20},
    { 0, 3,   1,  20}, { 3, 3,   1,   0}},
  "attack", {	-- #25
    { 0, 0,   2,  25}, { 0, 0,   2,  30}, { 0, 0,   3,  35}, {12, 0,   3,  40},
    { 0, 0,  8,   0}, { 3, 0,   1,   0}},
  "die", {	-- #507
    { 0, 0,   3,  45}, { 0, 0,   3,  50}, { 0, 0, 100,  55}, { 0, 0, 200,  60},
    { 0, 0, 200,  65}, { 3, 0,   1,  65}})
...
--------
--	Flying dish and other faster capital starships

DefineAnimations("animations-fastship",
  "still", {	-- #5
    { 0, 0,   4,   0}, { 3, 0,   1,   0}},
  "move", {	-- #26, P32
    { 0, 2,   1,   0}, { 0, 2,   1,   0}, { 0, 2,   1,   0}, { 0, 2,   1,   0},
